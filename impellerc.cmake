...
if(NOT IS_DIRECTORY ${SHADERC_INSTALL_DIR})
    message(SEND_ERROR
      "Unable to configure the impellerc target because the shaderc install "
      "directory (SHADERC_INSTALL_DIR) couldn't be found:"
      "    ${SHADERC_INSTALL_DIR}\n"
      "The shaderc build artifacts can be downloaded here:"
...
target_link_libraries(impellerc
    PRIVATE
        fml impeller_base impeller_geometry spirv-cross-glsl spirv-cross-msl shaderc_combined)
